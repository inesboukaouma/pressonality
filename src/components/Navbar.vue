  ...
  <div class="fixed top-0 left-0 right-0 bg-pink-500 py-4 z-50">
    ...
    <div v-if="isMenuOpen" class="lg:hidden">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        <a @click="navigateTo('/')" class="block px-3 py-2 text-white hover:bg-pink-600 cursor-pointer">Accueil</a>
        <a @click="navigateTo('/shop')" class="block px-3 py-2 text-white hover:bg-pink-600 cursor-pointer">Boutique</a>
        <a @click="navigateTo('/custom-nails')" class="block px-3 py-2 text-white hover:bg-pink-600 cursor-pointer"
          >Ongles personnalisés</a
        >
        <a @click="navigateTo('/find-your-size')" class="block px-3 py-2 text-white hover:bg-pink-600 cursor-pointer"
          >Trouver sa taille</a
        >
        <a @click="navigateTo('/guide')" class="block px-3 py-2 text-white hover:bg-pink-600 cursor-pointer">Guide</a>
        <a @click="navigateTo('/faq')" class="block px-3 py-2 text-white hover:bg-pink-600 cursor-pointer">FAQ</a>
      </div>
    </div>
  </div>
</template>
